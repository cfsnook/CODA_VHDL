 ...
 * @generated
 */
public class VHDLEnumerationLiteralTest extends TestCase {
	 ...
	 * @generated
	 */
	protected IVHDLEnumerationLiteral fixture = null;
	...
	public static void main(String[] args) {
		TestRunner.run(VHDLEnumerationLiteralTest.class);
	}
	 ...
	 * @generated
	 */
	public VHDLEnumerationLiteralTest(String name) {
		super(name);
	}
	 ...
	 * @generated
	 */
	protected void setFixture(IVHDLEnumerationLiteral fixture) {
	 ...
	 * @generated
	 */
	protected IVHDLEnumerationLiteral getFixture() {
		return fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(IVHDLFactory.eINSTANCE.createVHDLEnumerationLiteral());
	}
