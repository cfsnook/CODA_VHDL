...
/**
 * This is the item provider adapter for a {@link ac.soton.coda.vhdl.IVHDLGuardedStatementElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VHDLGuardedStatementElementItemProvider extends VHDLBooleanExpressionElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VHDLGuardedStatementElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((IVHDLGuardedStatementElement)object).getBooleanExpression();
		return label == null || label.length() == 0 ?
			getString("_UI_VHDLGuardedStatementElement_type") :
			getString("_UI_VHDLGuardedStatementElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IVHDLGuardedStatementElement.class)) {
